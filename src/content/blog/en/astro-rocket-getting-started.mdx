...
description: "How to install, configure, and deploy Astro Rocket — covering site.config.ts, brand colours, navigation, writing posts, and deploying to Cloudflare Pages."
publishedAt: 2026-04-19
author: "Hans Martens"
tags: ["astro-rocket", "getting-started", "configuration", "cloudflare"]
featured: true
locale: en
...
- A [Cloudflare account](https://cloudflare.com) (free) for deployment
...
1. Create a new repository on GitHub and push your local project to it
2. Go to [dash.cloudflare.com](https://dash.cloudflare.com) → **Workers & Pages → Create → Pages**
3. Connect your GitHub repository
4. Set the build command to `pnpm run build` and the output directory to `dist`
5. Add your environment variables under **Settings → Environment variables**, including:
...
Your site is live. Every subsequent push to `main` triggers a new deployment automatically. Cloudflare Pages also creates preview deployments for every pull request.
