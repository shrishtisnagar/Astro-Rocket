---
title: "Contact Form Setup: Resend, Cloudflare, and GoDaddy Step by Step"
description: "Astro Rocket's contact form is wired up but needs three things to actually deliver email: a Resend account, a verified domain, and one environment variable on Cloudflare Pages."
publishedAt: 2026-03-31
author: "Hans Martens"
tags: ["astro-rocket", "tutorial", "email", "cloudflare", "deployment"]
featured: false
locale: en
...
**[Cloudflare Pages](https://pages.cloudflare.com)** is the hosting platform this site runs on. It builds and deploys your Astro project on every push, and manages environment variables like API keys so they stay out of your source code.
...
- Access to your project's environment variables on Cloudflare Pages
...
## Step 4 — Add the API key to Cloudflare Pages
...
2. Find your latest deployment and click **Retry deployment**

Alternatively, push any small change to your main branch — Cloudflare Pages will build and deploy automatically.
...
|---------|-------------|
| "API key not authorized" | Domain not verified in Resend yet, or the API key was added without redeploying on Cloudflare Pages |
